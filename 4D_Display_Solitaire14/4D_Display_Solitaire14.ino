...
struct TP{                       // Scratch pad struct for storing tiles selected.
          int Locxy[4]; // x,y
          char* TileX[2];
          };
...
delay(1000);
         ...
         if (( x > 0 && x < 70) && ( y > 120 && y < 150))  // Tile D  
            {
